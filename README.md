# 🚀 Meus Estudos de Python & Algoritmos

Bem-vindo ao meu repositório de estudos! Aqui armazeno códigos, desafios e projetos práticos que desenvolvo enquanto avanço na minha jornada como desenvolvedor Back-End.

## 📚 Tecnologias & Estudos Atuais
- **Linguagem Principal:** Python 🐍
- **Foco Atual:** Lógica de programação estruturada e blindagem de código.
- **Teoria em Progresso:** Livro *"Entendendo Algoritmos"* (Aditya Bhargava) e conceitos do curso do Gustavo Guanabara.
...
Para rodar os códigos localmente, você precisará do Python instalado em sua máquina.

1. Clone o repositório:
```bash
git clone [https://github.com/YuriMesquitaTI/estudos-python.git](https://github.com/YuriMesquitaTI/estudos-python.git)
